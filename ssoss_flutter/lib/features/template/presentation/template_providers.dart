...
class TemplateProviders {
  ...
  static List<SingleChildWidget> build() => [
        ...
        ProxyProvider<TemplateRepository, EditSavedTemplateUseCase>(
          update: (_, repository, __) => EditSavedTemplateUseCase(repository),
        ),
        ProxyProvider<TemplateRepository, RenameSavedTemplateUseCase>(
          update: (_, repository, __) => RenameSavedTemplateUseCase(repository),
        ),
        ProxyProvider<TemplateRepository, DeleteSavedTemplateUseCase>(
          update: (_, repository, __) => DeleteSavedTemplateUseCase(repository),
        ),
        ProxyProvider<TemplateRepository, BookmarkTemplateUseCase>(
          update: (_, repository, __) => BookmarkTemplateUseCase(repository),
        ),
        ProxyProvider<TemplateRepository, UnbookmarkTemplateUseCase>(
          update: (_, repository, __) => UnbookmarkTemplateUseCase(repository),
        ),
        ProxyProvider<TemplateRepository, ListBookmarkedTemplatesUseCase>(
          update: (_, repository, __) =>
              ListBookmarkedTemplatesUseCase(repository),
        ),
      ];
}
