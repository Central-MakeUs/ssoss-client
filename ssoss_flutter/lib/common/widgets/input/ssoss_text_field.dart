...
class _SsossTextFieldState extends State<SsossTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    final resolvedHeight = widget.height ?? SsossTextField._defaultHeight;
    ...
    final resolvedFocusedBorderColor = widget.hasError
        ? resolvedErrorColor
        : widget.focusedBorderColor ?? AppColors.neutral600;
    ...
    final field = DecoratedBox(
      decoration: BoxDecoration(
        ...
        boxShadow: _hasFocus ? SsossTextField._focusedShadow : null,
      ),
